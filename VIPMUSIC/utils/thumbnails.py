...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("VIPMUSIC/assets/assets/font2.ttf", 30)
    font = ImageFont.truetype("VIPMUSIC/assets/assets/font.ttf", 30)
    title_font = ImageFont.truetype("VIPMUSIC/assets/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("VIPMUSIC/assets/assets/play_icons.png")
